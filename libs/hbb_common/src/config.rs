...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("ddns.ywsj365.com".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ddns.ywsj365.com"];
pub const RS_PUB_KEY: &str = "gHV1O3AZ0bNsB5wmQmxjIIeiICw9Q+gv2yIla1WuFXw=";
